...
namespace Endless.Gameplay
{
	...
	{
		// Token: 0x06000829 RID: 2089 RVA: 0x0002667C File Offset: 0x0002487C
		...
		// Token: 0x0600082A RID: 2090 RVA: 0x00026F04 File Offset: 0x00025104
		public static Dictionary<GenericWorldState, HashSet<GoapAction>> BuildActionMap(HashSet<GoapAction> actions)
		{
			...
			foreach (GoapAction goapAction in actions)
			{
				...
				{
					hashSet.Add(genericWorldState);
				}
				foreach (GenericWorldState genericWorldState2 in goapAction.Effects)
				{
					hashSet.Add(genericWorldState2);
				}
			}
			foreach (GenericWorldState genericWorldState3 in hashSet)
			{
				HashSet<GoapAction> hashSet2 = new HashSet<GoapAction>();
				foreach (GoapAction goapAction2 in actions)
				{
					if (goapAction2.Effects.Contains(genericWorldState3))
					{
						hashSet2.Add(goapAction2);
					}
				}
				dictionary.Add(genericWorldState3, hashSet2);
			}
			return dictionary;
		}
	}
