...
{
	protected override Task<GraphQlResult> RequestListTask => EndlessServices.Instance.CloudService.GetFriendRequestsAsync(base.PaginationParams);

	protected override ErrorCodes GetDataErrorCode => ErrorCodes.UIFriendRequestList_RequestListTask;
