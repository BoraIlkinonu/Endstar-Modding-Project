	...
	public static class JSONParser
	{
		...
		internal static object ParseValue(Type type, string json)
		{
			...
			else
			{
				...
				if (isPrimitive)
				{
					object obj2 = Convert.ChangeType(json, type, CultureInfo.InvariantCulture);
					obj = obj2;
				}
				else
				{
								...
								else
								{
									...
									else
									{
										...
										if (flag14)
										{
											...
											bool flag15 = type3 != typeof(string);
											if (flag15)
											{
												obj = null;
											}
													...
													else
													{
														...
														for (int l = 0; l < list4.Count; l += 2)
														{
															...
															if (!flag18)
															{
																...
																object obj3 = JSONParser.ParseValue(type4, list4[l + 1]);
																dictionary[text] = obj3;
															}
														}
														obj = dictionary;
													}
										...
										else
										{
											...
											if (flag19)
											{
												obj = JSONParser.ParseAnonymousValue(json);
											}
											else
											{
												...
												if (flag20)
												{
													obj = JSONParser.ParseObject(type, json);
												}
												else
												{
													obj = null;
		...
		// Token: 0x06000007 RID: 7 RVA: 0x0000293C File Offset: 0x00000B3C
		...
		// Token: 0x06000009 RID: 9 RVA: 0x00002C40 File Offset: 0x00000E40
			...
			else
			{
				...
				for (int i = 0; i < list.Count; i += 2)
				{
					...
					if (!flag4)
					{
						...
						FieldInfo fieldInfo;
						bool flag5 = dictionary.TryGetValue(text, out fieldInfo);
						if (flag5)
						{
						...
						else
						{
							...
							bool flag6 = dictionary2.TryGetValue(text, out propertyInfo);
							if (flag6)
							{
