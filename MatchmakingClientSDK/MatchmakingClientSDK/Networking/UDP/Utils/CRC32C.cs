...
namespace Networking.UDP.Utils
{
	...
	{
		// Token: 0x06000184 RID: 388 RVA: 0x00009868 File Offset: 0x00007A68
		static CRC32C()
		{
			for (uint num = 0U; num < 256U; num += 1U)
			{
				...
				for (int i = 0; i < 16; i++)
				{
					...
					checked
					{
						CRC32C.Table[(int)((IntPtr)(unchecked((long)(i * 256) + (long)((ulong)num))))] = num2;
					}
				}
			}
		}

		// Token: 0x06000185 RID: 389 RVA: 0x000098D8 File Offset: 0x00007AD8
		...
		private static readonly uint[] Table = NetUtils.AllocatePinnedUninitializedArray<uint>(4096);
	}
}
